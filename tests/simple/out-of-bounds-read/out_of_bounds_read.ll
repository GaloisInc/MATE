; ModuleID = 'out_of_bounds_read.bc'
source_filename = "out_of_bounds_read.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@test.secret = private unnamed_addr constant [14 x i8] c"Secret found!\00", align 1
@.str = private unnamed_addr constant [25 x i8] c"Enter how much to print\0A\00", align 1
...
define dso_local void @test() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %5, i8* align 1 getelementptr inbounds ([14 x i8], [14 x i8]* @test.secret, i32 0, i32 0), i64 14, i1 false)
